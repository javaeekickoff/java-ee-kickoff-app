 ...
 *
 */
public class KickoffServerAuthContext implements ServerAuthContext {

	private ServerAuthModule serverAuthModule;

	public KickoffServerAuthContext(CallbackHandler handler) throws AuthException {
		serverAuthModule = new KickoffServerAuthModule();
